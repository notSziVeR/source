...
public:
...
#ifdef ENABLE_RT_EXTENSION
	CWindow* RegisterRenderTarget(PyObject* object, const char* layer);
#endif
...
#ifdef ENABLE_RT_EXTENSION
	void		LockCursorOnWindow(CWindow* pWindow);
	void		UnlockCursor(CWindow* pWindow);
	bool		UpdateLockedCursor(int mouseX, int mouseY, POINT* lpReturnPoint);
#endif
	...
	// ScrollBar Support
	bool		RunMouseWheel(const int& nLen);
#endif
	...
	void		RunIMEUpdateSelectionEvent();
...
private:
	...
	long					m_lMouseRealX, m_lMouseRealY;
...
#ifdef ENABLE_RT_EXTENSION
	CWindow *				m_lockedMousePositionWindow;
	POINT					m_lockedMousePosition;
#endif
};
