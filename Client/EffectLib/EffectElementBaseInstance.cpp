...
void CEffectElementBaseInstance::SetParticleScale(float fScale)
{
	m_fScaleParticle = fScale;
}

void CEffectElementBaseInstance::SetMeshScale(D3DXVECTOR3 rv3Scale)
{
	m_v3ScaleMesh = rv3Scale;
}
