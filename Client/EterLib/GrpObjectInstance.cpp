...
void CGraphicObjectInstance::Initialize()
{
	...
	D3DXMatrixIdentity(&scaleMatrix_);
...
void CGraphicObjectInstance::Scale(const D3DXVECTOR3& scale)
{
	Scale(scale.x, scale.y, scale.z);
}

void CGraphicObjectInstance::Scale(float x, float y, float z)
{
	D3DXMatrixScaling(&scaleMatrix_, x, y, z);
}
