...
int GetTextTag(const wchar_t * src, int maxLen, int & tagLen, std::wstring & extraInfo, bool useIgnorePattern)
{
	tagLen = 1;
	...
	if (useIgnorePattern && *src == L'\\')
	{
		tagLen = 2;
		return TEXT_TAG_PLAIN_IGNORE;
	}
