...
const std::string &Exception::GetValue() const
{
	return m_value;
}

void Exception::SetStart(std::string::size_type start)
{
	m_start = start;
}

void Exception::SetEnd(std::string::size_type end)
{
	m_end = end;
}

std::string::size_type Exception::GetStart() const
{
	return m_start;
}

std::string::size_type Exception::GetEnd() const
{
	return m_end;
}
