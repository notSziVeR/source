...
bool CPythonSkill::RegisterSkill(DWORD dwSkillIndex, const char * c_szFileName)
{
	...
	{
		char szName[256];
		sprintf(szName, "%dname", CLocaleManager::instance().GetCodePage());
	...
	{
		char szName[256];
		sprintf(szName, "%ddescription", CLocaleManager::instance().GetCodePage());
...

	{
		...
		sprintf(szConditionData, "%dconditiondata", CLocaleManager::instance().GetCodePage());
...

	{
		...
		sprintf(szAffectData, "%daffectdata", CLocaleManager::instance().GetCodePage());
...

	{
		...
		sprintf(szGradeData, "%dgradedata", CLocaleManager::instance().GetCodePage());
