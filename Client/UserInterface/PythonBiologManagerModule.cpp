...
PyObject* biologManagerGetCurrentChance(PyObject* poSelf, PyObject* poArgs)
{
	auto iChance = CPythonBiologManager::Instance().Biolog_GetCurrentChance();
	return Py_BuildValue("i", iChance);
}
...
void initBiologManager()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetInfoChance",				biologManagerGetCurrentChance,				METH_VARARGS },
		{ NULL, NULL, NULL },
	};
