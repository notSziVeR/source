...
public:
	CMainPacketHeaderMap()
	{
		...
		Set(HEADER_GC_PARTY_POSITION, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCPartyPosition), STATIC_SIZE_PACKET));
#endif
		...
		Set(HEADER_GC_REQUEST_TREASURE_BOX_LOOT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketCGDefault), DYNAMIC_SIZE_PACKET));
#endif
		...
		Set(HEADER_GC_REQUEST_DELETE_SOCKET, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketCGDefault), DYNAMIC_SIZE_PACKET));
#endif
		...
		Set(HEADER_GC_VOICE_CHAT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCVoiceChat), STATIC_SIZE_PACKET));
#endif

#ifdef ENABLE_ADMIN_MANAGER
		Set(HEADER_GC_ADMIN_MANAGER_LOAD, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCAdminManagerLoad), DYNAMIC_SIZE_PACKET));
		Set(HEADER_GC_ADMIN_MANAGER, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCAdminManager), DYNAMIC_SIZE_PACKET));
#endif
		...
		Set(HEADER_GC_MARBLE_MANAGER, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCMarbleManager), DYNAMIC_SIZE_PACKET));
#endif

#ifdef ENABLE_CUBE_RENEWAL
		Set(HEADER_GC_CUBE_CRAFT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCCubeCraft), STATIC_SIZE_PACKET));
		Set(HEADER_GC_CUBE_ITEM, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCCubeItem), DYNAMIC_SIZE_PACKET));
#endif

#ifdef ENABLE_FIND_LETTERS_EVENT
		Set(HEADER_GC_FIND_LETTERS_INFO, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCFindLettersInfo), DYNAMIC_SIZE_PACKET));
#endif
		...
		Set(HEADER_GC_SHOW_TEAMLER, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCShowTeamler), STATIC_SIZE_PACKET));
		Set(HEADER_GC_TEAMLER_STATUS, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCTeamlerStatus), STATIC_SIZE_PACKET));
#endif
...
#ifdef ENABLE_OFFLINE_SHOP
		Set(HEADER_GC_OFFLINE_SHOP, CNetworkPacketHeaderMap::TPacketType(sizeof(net_offline_shop::GC_packet), DYNAMIC_SIZE_PACKET));
#endif

#ifdef ENABLE_SHOP_SEARCH
		Set(HEADER_GC_SHOP_SEARCH_RESULT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCShopSearchResult), DYNAMIC_SIZE_PACKET));
		Set(HEADER_GC_SHOP_SEARCH_BUY_RESULT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCShopSearchBuyResult), STATIC_SIZE_PACKET));
		Set(HEADER_GC_SHOP_SEARCH_OWNER_MESSAGE, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCShopSearchOwnerMessage), STATIC_SIZE_PACKET));
		Set(HEADER_GC_SHOP_SEARCH_SOLD_INFO, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCShopSearchSoldInfo), DYNAMIC_SIZE_PACKET));
#endif

#ifdef ENABLE_PING_TIME
		Set(HEADER_GC_PING_TIMER, CNetworkPacketHeaderMap::TPacketType(sizeof(BYTE), STATIC_SIZE_PACKET));
#endif

#ifdef ENABLE_NEW_LOGS_CHAT
		Set(HEADER_GC_CHAT_LOGS, CNetworkPacketHeaderMap::TPacketType(sizeof(net_logs_chat::GC_packet), STATIC_SIZE_PACKET));
#endif

#ifdef __MULTI_LANGUAGE_SYSTEM_FLAG_VISIBILITY__
		Set(HEADER_GC_WHISPER_LANGUAGE_INFO, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCWhisperLanguageInfo), STATIC_SIZE_PACKET));
#endif

#ifdef ENABLE_SHAMAN_SYSTEM
		Set(HEADER_GC_SHAMAN_SKILL, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCShamanUseSkill), STATIC_SIZE_PACKET));
#endif
