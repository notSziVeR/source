...
public:
	...
	void	CreateItem(DWORD dwVirtualID, DWORD dwVirtualNumber, float x, float y, float z, WORD count, bool bDrop = true);
#else
	...
	void	SetOwnership(DWORD dwVID, const char* c_pszName, int iDropType = true);
