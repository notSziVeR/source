...
PyObject* chrmgrClearRaceNameCache(PyObject* poSelf, PyObject* poArgs)
{
	CRaceManager::Instance().ClearRaceNameCache();
	return Py_BuildNone();
}
#endif

#ifdef ENABLE_HIDE_EFFECTS
PyObject* chrmgrShowHideEffectById(PyObject* poSelf, PyObject* poArgs)
{
	int iEffectId;
	if (!PyTuple_GetInteger(poArgs, 0, &iEffectId))
	{
		return Py_BadArgument();
	}
	...
	CPythonCharacterManager::Instance().ShowHideEffectById(iEffectId, isHide ? true : false);
	return Py_BuildNone();
}
#endif
...
void initchrmgr()
{
...
#ifdef ENABLE_DOG_MODE
		{ "ClearRaceNameCache",			chrmgrClearRaceNameCache,				METH_VARARGS },
#endif
#ifdef ENABLE_HIDE_EFFECTS
		{ "ShowHideEffectById",			chrmgrShowHideEffectById,				METH_VARARGS },
#endif
	...
	PyModule_AddIntConstant(poModule, "EFFECT_REFINE_ELEMENT", CInstanceBase::EFFECT_REFINE_ELEMENT);
