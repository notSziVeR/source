...
public:
	...
	virtual int64_t	GetStatus(DWORD dwType) = 0;
#else
	...
	virtual void	SetItemCount(TItemPos itemPos, CountType byCount) = 0;
	...
	virtual CountType	GetItemCount(TItemPos itemPos) = 0;
	...
	virtual DWORD	GetItemTransmutate(TItemPos Cell) = 0;
	virtual void	SetItemTransmutate(TItemPos Cell, DWORD trans_id) = 0;
#endif

#ifdef ENABLE_REFINE_ELEMENT
	virtual DWORD	GetItemRefineElement(TItemPos itemPos) = 0;
	virtual void	SetItemRefineElement(TItemPos itemPos, DWORD dwRefineElement) = 0;
#endif
