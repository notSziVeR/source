...
PyObject* safeboxGetItemTransmutate(PyObject* poSelf, PyObject* poArgs)
{
	int ipos;
	if (!PyTuple_GetInteger(poArgs, 0, &ipos))
	{
	...
	return Py_BuildValue("i", pInstance->transmutation_id);
}
#endif
...
#ifdef TRANSMUTATION_SYSTEM
		{ "GetItemTransmutate",			safeboxGetItemTransmutate,				METH_VARARGS },
#endif
