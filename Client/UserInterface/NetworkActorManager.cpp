...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	m_bRefineElementType = src.m_bRefineElementType;
#endif
...
#endif
#ifdef ENABLE_REFINE_ELEMENT
	kCreateData.m_bRefineElementType = rkNetActorData.m_bRefineElementType;
#endif
#ifdef ENABLE_QUIVER_SYSTEM
	kCreateData.m_dwArrow = rkNetActorData.m_dwArrow;
#endif
#ifdef ENABLE_MULTI_LANGUAGE_SYSTEM
	kCreateData.m_bLocale = rkNetActorData.m_bLocale;
#endif
...
#ifdef ENABLE_REFINE_ELEMENT
		pkInstFind->SetRefineElementType(c_rkNetUpdateActorData.m_bRefineElementType);
#endif
...
#endif
#ifdef ENABLE_REFINE_ELEMENT
	rkNetActorData.m_bRefineElementType = c_rkNetUpdateActorData.m_bRefineElementType;
#endif
#ifdef ENABLE_QUIVER_SYSTEM
