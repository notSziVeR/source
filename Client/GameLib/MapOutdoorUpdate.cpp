...
// 2004.08.17.myevan.std::vector ¸¦ »çżëÇŇ °ćżě ¸Ţ¸đ¸® Á˘±Ůżˇ żŔ·ˇ°É·Á ˝şĹĂÂĘŔ¸·Î °č»ęÇĎµµ·Ď ĽöÁ¤
...
void CMapOutdoor::__Game_UpdateArea(D3DXVECTOR3& v3Player)
{
	...
	D3DXVECTOR3 v3Light = D3DXVECTOR3(1.732f, 1.0f, -3.464f); // şűŔÇ ąćÇâ
...
void CMapOutdoor::UpdateTerrain(float fX, float fY)
{
	...
	if ((m_lCenterX != m_lOldReadX) || (m_lCenterY != m_lOldReadY))
	{
		...
		//Tracef("»çżëÇĎ´Â Area, Terrain : (%d, %d), Áöżď Area, Terrain : (%d, %d)\n",
