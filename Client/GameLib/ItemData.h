...
#define ITABLE_PROCESS(len)\
					...
					ITABLE_COPY_INT(equipmentSetId);
...
#endif
	uint32_t GetEquipmentSetId() const { return m_ItemTable.equipmentSetId; }
...
public:
	void		SetLetterAscii(BYTE letterAscii);
protected:
	BYTE		bLetterAscii;
#endif
