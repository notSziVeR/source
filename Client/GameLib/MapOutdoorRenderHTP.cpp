...
void CMapOutdoor::__RenderTerrain_RenderHardwareTransformPatch()
{
...
#ifdef WORLD_EDITOR
	/*Contact me for Costume world editor sources*/
	...
	// NOTE: Word Editor ĹřżˇĽ­´Â fog farş¸´Ů ¸Ö¸®ŔÖ´Â ą°ĂĽ¸¦ ĹŘ˝şĂÄ ľřŔĚ ±×¸®´Â ŔŰľ÷Ŕ» ÇĎÁö ľĘŔ˝
#ifdef WORLD_EDITOR
	...
	// NOTE: ¸ĘĹřżˇĽ­´Â view ~ fog near »çŔĚŔÇ ÁöÇüŔ» fog disabled »óĹÂ·Î ±×¸®´Â ŔŰľ÷Ŕ» ÇĎÁö ľĘŔ˝.
#ifndef WORLD_EDITOR
