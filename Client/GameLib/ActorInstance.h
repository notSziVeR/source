...
public:
	...
	void AttachSash(DWORD dwParentPartIndex, DWORD dwPartIndex, CItemData* pItemData);
	void AttachSash(DWORD dwItemIndex, DWORD dwParentPartIndex, DWORD dwPartIndex);
#endif
	...
	const std::list<TAttachingEffect>& GetAttachedAffectList() { return m_AttachingEffectList; }
#endif
