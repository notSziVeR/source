...
extern CountType g_bItemCountLimit;
...
extern bool is_twobyte(const char* str);
extern bool check_name(const char* str);
...
extern std::string g_strWebMallURL;
	...
	extern std::string g_AccountDatabase;
#endif
...
extern unsigned int g_uiSpamReloadCycle;
	...
	extern unsigned long long max_gold;
#endif
...
extern int MAX_ATTACK_RANGE;

extern int STONE_PERCENT_VALUE;
extern int ACCESSORY_PERCENT_VALUE;
extern int BOOK_DELAY_MIN;
extern int BOOK_DELAY_MAX;
