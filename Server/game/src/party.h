...
public:
	...
	const TMemberMap& GetMemberMap() const { return m_memberMap; }
#endif
...
public:
	...
	DWORD GetRandomPID(DWORD my_pid, bool bDungeon);

#ifdef __CROSS_CHANNEL_DUNGEON_WARP__
public:
	BYTE PopulatePartyPids(DWORD tPids[]);
	LPCHARACTER GetRandomPartyMember();
#endif
};
