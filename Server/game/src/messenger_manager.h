...
public:
	...
	void	UpdateOnList(MessengerManager::keyA account, MessengerManager::keyA companion, MessengerManager::keyA new_name);
	void	UpdateAllList(MessengerManager::keyA account, MessengerManager::keyA name_new);
