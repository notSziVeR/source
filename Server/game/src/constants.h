...
#ifdef __BELT_ATTR__
	typedef std::map<DWORD, TItemBeltAttrTable> TItemBeltAttrMap;
	extern TItemBeltAttrMap g_map_itemBelt;
#endif
...
extern const int32_t APPLY_COMPOSITION_REFERENCE_VALUE;
extern const std::unordered_map<uint8_t, std::vector<std::pair<uint8_t, int32_t>>> APPLY_COMPOSITIONS;
