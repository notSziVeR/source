...
#ifdef __BELT_ATTR__
	TItemBeltAttrMap g_map_itemBelt;
#endif
	 ...
	 */
{
	...
	{ POINT_ATTBONUS_ELEC, },	// APPLY_ENCHANT_ELECT,		99
	{ POINT_ATTBONUS_FIRE, },	// APPLY_ENCHANT_FIRE		100
	{ POINT_ATTBONUS_ICE, },	// APPLY_ENCHANT_ICE		101
	{ POINT_ATTBONUS_WIND, },	// APPLY_ENCHANT_WIND		102
	{ POINT_ATTBONUS_EARTH, },	// APPLY_ENCHANT_EARTH		103
	{ POINT_ATTBONUS_DARK, },	// APPLY_ENCHANT_DARK		104
	{ POINT_ATTBONUS_INSECT, },	// APPLY_ATTBONUS_INSECT	105
	{ POINT_ATTBONUS_DESERT, },	// APPLY_ATTBONUS_DESERT	106
	{ POINT_ATTBONUS_CZ, },	// APPLY_ATTBONUS_CZ			107
#endif
...
const SStoneDropInfo aStoneDrop[STONE_INFO_MAX_NUM] =
{
	...
	{8007, 60, {24, 29, 33, 13, 1} },
	{8008, 60, {22, 28, 34, 15, 1} },
	{8009, 60, {21, 27, 34, 17, 1} },
	{8010, 60, {18, 26, 35, 20, 1} },
	{8011, 60, {14, 26, 37, 22, 1} },
	{8012, 60, {10, 26, 39, 24, 1} },
	{8013, 60, {2, 26, 42, 29, 1} },
	{8014, 60, {0, 26, 43, 30, 1} },
};
...
TValueName c_aApplyTypeNames[] =
{
	...
	{ "DUNGEON_DAMAGE_BONUS",	APPLY_DUNGEON_DAMAGE_BONUS },
	{ "DUNGEON_RESIST_BONUS", APPLY_DUNGEON_RECV_DAMAGE_BONUS },

	{ "AGGRO_MONSTER_BONUS",  APPLY_AGGRO_MONSTER_BONUS },
	{ "DOUBLE_DROP_ITEM",	APPLY_DOUBLE_ITEM_DROP_BONUS },
...
// Apply values are 1:1000
const int32_t APPLY_COMPOSITION_REFERENCE_VALUE = 1000;

const std::unordered_map<uint8_t, std::vector<std::pair<uint8_t, int32_t>>> APPLY_COMPOSITIONS =
{
	{
		APPLY_PRECISION,
		{
...
extern const std::map<BYTE, std::pair<BYTE, BYTE>> m_ConstantSkillPercents =
{
	{SKILL_MASTER, std::make_pair(40, 40)},
	{SKILL_GRAND_MASTER, std::make_pair(15, 10)},
};

#ifdef __ENABLE_EQUIPMENT_SLOT_LOCK_SYSTEM__
extern const std::map<DWORD, std::pair<BYTE, std::string>> m_EquipmentLockInfo =
{
	{179001, { WEAR_UNIQUE4, "UNIQUE_4"} },
#ifdef __ENABLE_AMULET_SYSTEM__
	{179002, { WEAR_AMULET, "AMULET" }},
#endif
};
#endif

#ifdef __ENABLE_HIDE_COSTUMES__
extern const std::map<std::string, BYTE> m_HideCostume =
{
	{ "HEAD", COSTUME_FLAG_HEAD },
	{ "BODY", COSTUME_FLAG_BODY },
	{ "WEAPON", COSTUME_FLAG_WEAPON },
#ifdef __ENABLE_SASH_SYSTEM__
	{ "SASH", COSTUME_FLAG_SASH },
#endif
};
#endif
