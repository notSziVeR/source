...
public:
	void		SetFlag(const string & name, long value, bool bSkipSave = false);
	long		GetFlag(const string & name);
...
private:
	...
	void		SaveFlag(const string & name, long value);
...
private:
	...
	typedef map<string, long> TFlagMap;
	TFlagMap		m_FlagMap;
